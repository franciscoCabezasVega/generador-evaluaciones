 ...
 */
export const TOURS_METADATA: Record<
  Exclude<TourType, null>,
  { title: string; description: string; icon: string }
> = {
  tasks: {
    title: "Gestión de Tareas",
    description:
      "Aprende a crear, editar y gestionar tareas. Incluye explicación de productos, squads dinámicos y cálculo de notas.",
    icon: "📋",
  },
  reports: {
    title: "Generación de Reportes",
    description:
      "Descubre cómo generar, visualizar y descargar reportes con comentarios de IA.",
    icon: "📊",
  },
  audit: {
    title: "Auditoría y Logs",
    description:
      "Revisa el registro completo de cambios realizados en tareas y reportes.",
    icon: "🔐",
  },
  feedback: {
    title: "Reportar Problemas",
    description:
      "Aprende cómo reportar problemas, sugerencias e incidencias para ayudarnos a mejorar.",
    icon: "💬",
  },
};
