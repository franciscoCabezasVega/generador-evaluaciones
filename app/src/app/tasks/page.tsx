    ...
    if (editingTask) {
      ...
      const optimisticTask: TaskWithSquads = {
        ...
        squads: data.squads.map((sq) => ({
          ...
          calculated_score:
            editingTask.squads?.find((s) => s.squad === sq.squad)
              ?.calculated_score ?? 0,
      ...
      <main className="max-w-7xl mx-auto px-4 py-8">
        ...
        {authLoading ? (
          <div className="bg-blue-100 border border-blue-200 rounded-lg p-4 mb-6">
            <p className="text-sm text-blue-600">Cargando permisos...</p>
          </div>
        ) : (
          !canManageTasks && (
        ...
        {/* Buscador */}
        <div
          className="bg-gray-100 border border-gray-200 rounded-xl p-5 mb-2"
          data-tour="task-search"
        >
        ...
        {showFilters && (
          <div
            className="bg-gray-100 border border-gray-200 rounded-xl p-5 mb-6"
            ...
            <div className="grid grid-cols-5 gap-4">
              ...
              <div>
                ...
                <select
                  id="filter-squad"
                  value={filters.squad}
                  onChange={(e) => updateFilters({ squad: e.target.value })}
        ...
        {loading ? (
          ...
          <div
            className="bg-gray-100 border border-gray-200 rounded-xl overflow-x-auto fade-in-smooth"
