...
const FEATURE_CARDS = [
  {
    ...
    label: "Tareas",
    description:
      "Crea, edita y gestiona las evaluaciones mensuales de tareas por squad.",
  ...
  },
  {
    ...
    label: "Reportes",
    description:
      "Visualiza y descarga los reportes mensuales de desempeño con análisis IA.",
  ...
  },
  {
    ...
    label: "Tiempos",
    description:
      "Registra y analiza métricas de tiempos de QA por tarea y sprint.",
  ...
  },
  {
    ...
    label: "Auditoría",
    description:
      "Historial completo de acciones: creaciones, ediciones y eliminaciones.",
      ...
      <main className="max-w-7xl mx-auto px-4 py-12">
        ...
        <div className="mb-12">
          ...
          <p className="text-gray-600 text-lg max-w-xl">
            Gestiona las evaluaciones mensuales de calidad para los equipos de
            fábrica.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5 mb-10">
          {FEATURE_CARDS.map(
            ({
              ...
              >
                <div
                  className={`w-10 h-10 rounded-lg bg-gray-200 flex items-center justify-center mb-4 transition-transform group-hover:scale-110`}
                >
