...
jest.mock('@/lib/fetchAuth', () => ({
  authenticatedFetch: jest.fn((url: string, options?: RequestInit) => global.fetch(url, options)),
}));
...
describe('useFeedback Hook', () => {
  beforeEach(() => {
    ...
    (authenticatedFetch as jest.Mock).mockImplementation((url: string, options?: RequestInit) => global.fetch(url, options));
  });
